 ...
 * Source: Combined from Akan-Corporate-Packages-v3.2.pdf & v6.pdf
 */
...
export const FULL_MENU = {
  ...
  salad: {
    label: 'Salad',
    items: ['Green Salad', 'Mexican Bean Salad', 'Russian Salad', 'Papdi Chaat', 'Pineapple Raita', 'Boondi Raita', 'Papdi Chat Salad', 'Veg Green Salad', 'Mexican Beans Salad'],
  },
  accompaniments: {
